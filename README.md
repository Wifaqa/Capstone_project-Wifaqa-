...
وفاق (Wifaqa) هو نظام ذكي لمواءمة السير الذاتية مع الوظائف باستخدام الذكاء الاصطناعي،  
يجمع بين القواعد المنطقية (Rule-Based) ونماذج اللغة الكبيرة (LLMs) مع البحث الدلالي المتقدم.
